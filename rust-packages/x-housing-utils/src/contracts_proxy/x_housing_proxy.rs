    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn get_user_referrals<
        Arg0: ProxyArg<usize>,
    >(
        self,
        id: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, MultiValueEncoded<Env::Api, MultiValue2<usize, ManagedAddress<Env::Api>>>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getUserReferrals")
            .argument(&id)
            .original_result()
    }
